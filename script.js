...
// =========== read file and write file with asynchronous way ===========
fs.readFile("text.txt", "utf-8", (err, data1) => {
  err && console.log("error from data1");
  ...
  fs.readFile("text2.txt", "utf-8", (err, data2) => {
    ...
    fs.readFile("text3.txt", "utf-8", (err, data3) => {
      ...
      fs.writeFile("./final.txt", data3, "utf-8", (err) => {
        err
          ? console.log("error from data3 write file ")
          : console.log("Your file has been written !");

        fs.readFile("final.txt", "utf-8", (err, data4) => {
          console.log(data4);
        });
      });
    });
